<template>
  <div class="system-table-box">
    <el-table v-bind="$attrs" class="system-table" border height="100%" :data="data"
    ...
    <el-pagination v-if="showPage" :current-page="page.index" class="system-page alignment_right" background
                   :total="page.total" :page-size="page.size" :pager-count="5" @current-change="handleCurrentChange"
