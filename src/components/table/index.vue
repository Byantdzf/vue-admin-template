<template>
  <div class="system-table-box">
    <el-table v-bind="$attrs" class="system-table" border height="100%" :data="data" @selection-change="handleSelectionChange">
    ...
    <el-pagination v-if="showPage" :current-page="page.index" class="system-page alignment_right" background :total="page.total" :page-size="page.size" :pager-count="5" @current-change="handleCurrentChange" @size-change="handleSizeChange">
    </el-pagination>
  </div>
</template>
...
const props = defineProps({
  ...
  page: { // 分页参数
    type: Object,
    default: () => {
      return { index: 1, size: 15, total: 0 }
    }
  },
